...
console.log(some_random_variable)
// if we were to write the code without line 42 it would just print out undefined
// the moment we define the variable it still keeps undefined

// A Better of Declaring a variable is by using 'let' and/or 'const'
// Example console log
let full_name = first_name + ' Smiths'
...
console.log(find_floor) // expected output of 25

// Find the ceiling of a decimal
let find_ceil = Math.ceil(25.8)
console.log(find_ceil) // expected output of 26
...
//? turnary opertator if true return minor after the colon its like an if else statement
console.log(determine_Age(9))
...
// when we want to pass in a variable we neeed a $ sign
...
// Method #2 for looping through an array with for each method
